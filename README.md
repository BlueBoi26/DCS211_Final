...
Utilizing this data, a csv file is created of the data with the file CountyDataAPI.py. Then, Map.py loads in this csv and uses folium to create a US map
displaying all of the states. The map is interactable through JavaScript, and clickling on any state loads a new map of just that states with the counties outlined.
From here, clicking on any county highlights it brings up the data about that area. If two or more counties are selected, the information panel shows the averages values
